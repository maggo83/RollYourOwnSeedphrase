...
This project examines how to generate a BIP-39 mnemonic from six-sided dice, including the effects of imperfect dice, different methods for converting rolls into bits, practical attacker capabilities, and the operational tradeoffs of each procedure.
...
The numerical guarantees depend on explicit assumptions about die bias and independent rolling. Product labels alone do not prove those assumptions. Regardless of the mathematical method, observation, malware, compromised hardware, transcription mistakes, and insecure backups can be more realistic threats than brute force.
