...
class BuildTests(unittest.TestCase):
    ...
    def test_root_index_is_the_only_generated_compatibility_output(self) -> None:
        ...
        self.assertEqual(root_index, build_module.generated_root_html(online))
        ...
        self.assertIn('href="guide-src/styles.css"', root_index)
        self.assertIn('src="guide-src/script.js"', root_index)
        self.assertIn('src="guide-src/assets/', root_index)
    ...
    def test_offline_artifact_is_self_contained(self) -> None:
        ...
        for name in (
            "index.html", "styles.css", "script.js", "sha256.js",
