...
class BuildTests(unittest.TestCase):
    ...
    def test_quick_guides_use_shared_template_and_paired_catalog(self) -> None:
        ...
        self.assertIn("Choose either 12 or 24 words.", english_print)
        self.assertIn("Du kannst diese gedruckte Anleitung für eine echte Seed-Phrase verwenden.", german_print)
        self.assertIn("Wähle frei zwischen 12 und 24 Wörtern.", german_print)
    ...
    def test_dice_policy_and_guide_use_are_consistent(self) -> None:
        ...
        self.assertNotIn("selectedDice", source_script)
        self.assertNotIn("data-dice=", online + german + offline)
        self.assertNotIn("data-binary-warning", online + german + offline)
        self.assertIn("Use plain, well-made dice.", online)
        self.assertIn("Use plain, well-made dice.", offline)
